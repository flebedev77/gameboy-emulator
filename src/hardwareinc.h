...
#define _VRAM         0x8000 // 0x8000->0x9FFF
#define _VRAM8000     _VRAM
#define _VRAM8800     _VRAM+0x800
#define _VRAM9000     _VRAM+0x1000
#define _SCRN0        0x9800 // 0x9800->0x9BFF
#define _SCRN1        0x9C00 // 0x9C00->0x9FFF
#define _SRAM         0xA000 // 0xA000->0xBFFF
#define _RAM          0xC000 // 0xC000->0xCFFF / 0xC000->0xDFFF
#define _RAMBANK      0xD000 // 0xD000->0xDFFF
#define _OAMRAM       0xFE00 // 0xFE00->0xFE9F
#define _IO           0xFF00 // 0xFF00->0xFF7F,0xFFFF
#define _AUD3WAVERAM  0xFF30 // 0xFF30->0xFF3F
#define _HRAM         0xFF80 // 0xFF80->0xFFFE

// *** MBC5 Equates ***

#define rRAMG         0x0000 // 0x0000->0x1fff
#define rROMB0        0x2000 // 0x2000->0x2fff
#define rROMB1        0x3000 // 0x3000->0x3fff - If more than 256 ROM banks are present.
#define rRAMB         0x4000 // 0x4000->0x5fff - Bit 3 enables rumble (if present)
...
#define IEF_STAT    0b00000010 // STAT
...
// --
#define AUDLEN_DUTY_12_5     0b00000000 // 12.50b
#define AUDLEN_DUTY_25       0b01000000 // 250b
#define AUDLEN_DUTY_50       0b10000000 // 500b
#define AUDLEN_DUTY_75       0b11000000 // 750b
...
#define OAMA_Y              RB  1   // y pos
#define OAMA_X              RB  1   // x pos
